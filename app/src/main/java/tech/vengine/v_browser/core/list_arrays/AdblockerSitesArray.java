package tech.vengine.v_browser.core.list_arrays;

public class AdblockerSitesArray {

    /**
     * Created by Dalton on 7/22/2017.
     */

    private static String[] adsites = {
            //Custom Urls
            "badoink.com",
            "bf293.com",
            "redirect",
            ...
            //Block Full Links
            "m.sexy.com",
            "spankingtube.com/ads/300x250-spank-orange.jpg",
            "postyourgirls.com/iktg_160x600_242685.gif",
            "postyourgirls.com/st-700x200-5.jpg",
            "postyourgirls.com/banner06.jpg",
            "postyourgirls.com/banner10.jpg",
            "postyourgirls.com/banner12.jpg",
            "postyourgirls.com/header/header1.jpg",
    ...
    public static boolean checkUrlInAdblockArray(String value) {


        for (String site : adsites) {
		...
		for (int x=0; x < adsites.length; x++ ) {
			found = value.contains(adsites[x]);
			if (found) {
				return true;
			}
		}*/
